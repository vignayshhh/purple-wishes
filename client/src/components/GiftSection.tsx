            ...
            {!isOpen ? (
              ...
              >
                <motion.div
                  animate={{ 
                    y: [0, -20, 0],
                    filter: ["drop-shadow(0 0 20px rgba(168,85,247,0.3))", "drop-shadow(0 0 50px rgba(168,85,247,0.6))", "drop-shadow(0 0 20px rgba(168,85,247,0.3))"]
                  }}
                  transition={{ 
                    duration: 2,
                    repeat: Infinity,
                ...
                <p className="mt-8 text-2xl font-handwriting text-purple-200 animate-pulse">
              ...
              >
                ...
                <div className="space-y-4 text-purple-100 font-sans text-lg leading-relaxed">
                  <p>
                    I really wanted to get you this but hehe dhuddu illa Sakthiiii hahaha...
                  </p>
                  <p>
                    So i am keeping photo alone here.. I noticed that you are much more happier if you sleep well.. 
                  </p>
                  <p className="font-medium text-white">
                    So here are these purple earplugs from Loop to help you sleep peacefully like a little princess 💜
                  </p>
                </div>
              </motion.div>
            )}
